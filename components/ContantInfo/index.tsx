...
function Contant_Info({ item }: { item: AnmieType }) {
  return (
    <View style={styles.ContainerContant}>
      ...
      <View style={styles.secRow}>
        ...
        <View style={styles.secRowContant}>
          <Text style={styles.titles}>{item.duration}</Text>
          <DurationIcon />
        </View>
        <View style={styles.secRowContant}>
          <Text style={styles.titles}>{item.rank ?? "unknow"}</Text>
          <RankIcon />
        </View>
        <View style={styles.secRowContant}>
          <Text style={styles.titles}>{item.favorites}</Text>
          <LoveIcon />
        </View>
      </View>
    </View>
